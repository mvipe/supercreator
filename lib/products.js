...
export const PRODUCT_DEFAULTS = {
  ...
  payment: {
    ...
    data: {
      // A payment page is now built exactly like a course page: cover media,
      // a rich description, highlights, FAQs and a sticky buy card.
      coverImages: [], coverVideo: "",
      subtitle: "",
      description: "Describe your page so buyers know what they're paying for. Include what's included, who it's for and what happens after payment.",
      highlights: [],
      faqs: [],
      // Digital-product delivery: any number of download links (Google Drive,
      // Dropbox, direct URLs…). Shown to the buyer right after they pay.
      fileLinks: [],
      collectName: true, collectPhone: true, collectNote: false,
      noteLabel: "Anything we should know?",
      successMessage: "Payment received. Thank you!",
      priceMode: "fixed", price: 499, minPrice: 99,
      buttonText: "Get it now", accent: "#2E6EF7"
    }
  },
  book: {
    title: "Untitled book",
    data: {
      ...
      // Same shape as a course: bullet points + FAQs render on the sales page.
      highlights: [],
      faqs: [],
      pages: 0, format: "PDF",
      fileUrl: "", fileName: "",
