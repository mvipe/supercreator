...
export default function Learn() {
  ...
  return (
    <main>
      ...
      {active && (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/70 p-4 sm:items-center" onClick={() => setActive(null)}>
          <div className="my-auto max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white" onClick={(e) => e.stopPropagation()}>
